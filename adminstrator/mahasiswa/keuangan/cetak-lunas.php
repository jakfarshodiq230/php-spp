...
// session_start();
// ob_start();
$kode_pembayaran = @$_GET['kode_pembayaran_spp'];
$nim = @$_GET['nim'];
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        ...
        <div id="isi">
            ...
            <hr><br>
            <?php
                $sql = mysqli_query($mysqli, "SELECT tb_pembayaran.tanggal,tb_tagihan_spp.nim,tb_jenis_spp.keterangan_spp,tb_mahasiswa.nama_mahasiswa,tb_mahasiswa.nim, tb_pembayaran.jumlah_bayar,tb_tahun_ajaran.semester, tb_tahun_ajaran.tahun_ajaran,tb_tagihan_spp.keterangan,tb_pembayaran.keterangan_pembayaran,tb_pembayaran.jumlah_bayar FROM tb_tagihan_spp,tb_spp,tb_jenis_spp,tb_tahun_ajaran,tb_pembayaran,tb_mahasiswa WHERE tb_tagihan_spp.kode_spp=tb_spp.kode_spp AND tb_spp.kode_jenis_spp=tb_jenis_spp.kode_jenis_spp AND tb_spp.kode_tahun_ajaran=tb_tahun_ajaran.kode_tahun_ajaran AND tb_tagihan_spp.kode_tagihan=tb_pembayaran.kode_tagihan AND tb_tagihan_spp.nim=tb_mahasiswa.nim AND tb_pembayaran.kode_pembayaran='$kode_pembayaran' AND tb_mahasiswa.nim ='$nim' ")or die('Ada kesalahan pada query tampil Transaksi : '.mysqli_error($mysqli));
            ?>
            <div id="identitas">
            ...
            <div id="identitas">
                <i><b style="font-size: 20px;">Belum Lunas Melakukan Pembayarn <?php echo ucwords($data['keterangan_spp']) ?> </b></i> 
            </div>
            ...
            <br>
            <div id="keterangan">
                <p><b>* Catatan</b><br> - Kuitansi ini Merupakan Bukti Pembayaran Yang Sah.<br>- Mintak Verifikasi Kuitansi Kepada Yang Bersangkutan. <br> - Simpan Bukti Pembayaran Untuk Mencetak Kuitansi Pembayaran Yang Lunas.</P>
            </div>
        </div>
    </body>
