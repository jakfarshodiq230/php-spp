...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        ...
        <div id="isi">
            ...
            ?>
            <div id="identitas">
                <i><b style="font-size: 20px;">Belum Lunas Melakukan Pembayarn SPP</b></i> 
            </div>
            <?php
                }
            ?>
            ...
            <br>
            <div id="keterangan">
                <p><b>* Catatan</b><br> - Kuitansi ini Merupakan Bukti Pembayaran Yang Sah. <br> - Simpan Bukti Pembayaran ini.</P>
            </div>
        </div>
    </body>
